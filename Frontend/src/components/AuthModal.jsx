...
import { X, User, Mail, Lock, Building, Shield, LogIn, UserPlus, Sparkles } from 'lucide-react';
...
export default function AuthModal({ isOpen, onClose, onAuthSuccess }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white border border-slate-200 rounded-3xl max-w-md w-full p-6 shadow-2xl relative max-h-[90vh] overflow-y-auto">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs tracking-wide shadow-md shadow-emerald-600/20 transition-all mt-4"
          >
        ...
        <div className="mt-6 pt-5 border-t border-slate-100">
          ...
          <div className="space-y-1.5">
            <button
              ...
              className="w-full text-left p-2.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 flex items-center justify-between text-xs transition-colors"
            >
              <div>
                <span className="font-bold text-slate-800 block">Sneha Verma</span>
                <span className="text-[10px] text-emerald-600 font-semibold">Block Supervisor • Block A</span>
              </div>
            ...
            >
              <div>
                <span className="font-bold text-slate-800 block">Dr. Rajesh Sharma</span>
                <span className="text-[10px] text-blue-600 font-semibold">Campus Admin • Campus-wide</span>
              </div>
